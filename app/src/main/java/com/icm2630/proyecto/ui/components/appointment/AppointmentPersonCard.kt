...
@Preview(
    showBackground = true,
    name = "Cita - Perfil personal"
)
@Composable
private fun AppointmentPersonCardPersonalPreview() {
...
@Preview(
    showBackground = true,
    name = "Cita - Persona asociada"
)
@Composable
private fun AppointmentPersonCardAssociatedPreview() {
